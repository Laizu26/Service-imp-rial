          ...
          <div className="flex h-screen overflow-hidden bg-[#e6e2d6]">
            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden w-full relative">
              ...
              <main className="flex-1 p-4 md:p-6 overflow-hidden relative z-10">
                <div className="w-full h-full overflow-y-auto scrollbar-thin scrollbar-thumb-stone-400 dark:scrollbar-thumb-stone-600 scrollbar-track-stone-200 dark:scrollbar-track-stone-900 pb-10">
                  {activeTab === "dashboard" &&
