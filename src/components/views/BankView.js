...
const BankView = ({
  ...
  const typeLabels = {
    ...
    STAFF_LOAN_FEE: "Détachement (loyer)",
    STAFF_LOAN_BONUS: "Détachement (prime)",
  ...
  const typeColors = {
    ...
    STAFF_LOAN_FEE: "bg-fuchsia-100 text-fuchsia-700 border-fuchsia-200",
    STAFF_LOAN_BONUS: "bg-fuchsia-100 text-fuchsia-700 border-fuchsia-200",
    ...
    TRIAL_FINE: "bg-red-100 text-red-700 border-red-200",
    GUILD: "bg-purple-100 text-purple-700 border-purple-200",
    PROPERTY_SALE: "bg-rose-100 text-rose-700 border-rose-200",
    PROPERTY_STAFF: "bg-teal-100 text-teal-700 border-teal-200",
